...
class ResourceController extends Controller
{
     ...
     *
     * @Route("/new/{videogameid}", name="resource_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request, $videogameid)
    {
        ...
        $resource->setVideogame($videogame);
    ...
    public function editAction(Request $request, Resource $resource)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('videogame_show', array('id' => $resource->getVideogame()->getId()));
        }
     ...
     *
     * @Route("/{id}/delete", name="resource_delete")
     * @Method("DELETE")
     */
